...
namespace SimplePartLoader.CarGen
{
    internal class Wolf : ICarBase
    {
        ...
        public void ForceTemplateExceptions(BuildingExceptions exceptions)
        {
            ...
            exceptions.ExceptionList["InnerPanelRL12"] = "none";
            exceptions.ExceptionList["InnerPanelRR12"] = "none";
            exceptions.ExceptionList["InnerPanelRLw12"] = "none";
            exceptions.ExceptionList["InnerPanelRRw12"] = "none";
        ...
        public void PostBuild(GameObject objective, Car car)
        {
            ...
            Transform radiator = objective.transform.Find("RadiatorSupport12/RadiatorSupport12/Radiator12/Radiator12");
            if (radiator)
            {
            ...
            Transform gasTank = objective.transform.Find("FloorTrunk12/FloorTrunk12/GasTank12/GasTank12");
            if (gasTank)
            {
            ...
            Transform brakeFluidContainer = objective.transform.Find("Firewall12/Firewall12/BrakeMasterCylinder12/BrakeMasterCylinder12");
            ...
            // Window lifts
            //FL
            WindowLift FL_WindowLift = objective.transform.Find("Firewall12/Firewall12/DoorFL12/DoorFL12/WindowLiftFL12/WindowLiftFL12").GetComponent<WindowLift>();
            if(FL_WindowLift)
            {
                FL_WindowLift.Window = objective.transform.Find("Firewall12/Firewall12/DoorFL12/DoorFL12/WindowLiftFL12/WindowLiftFL12/WindowFL12").gameObject;
                FL_WindowLift.WindowClosed = objective.transform.Find("Firewall12/Firewall12/DoorFL12/DoorFL12/WindowLiftFL12/WindowLiftFL12/windUP").gameObject;
                FL_WindowLift.WindowOpen = objective.transform.Find("Firewall12/Firewall12/DoorFL12/DoorFL12/WindowLiftFL12/WindowLiftFL12/WinDown").gameObject;
            }

            // FR
            WindowLift FR_WindowLift = objective.transform.Find("Firewall12/Firewall12/DoorFR12/DoorFR12/WindowLiftFR12/WindowLiftFR12").GetComponent<WindowLift>();
            if (FR_WindowLift)
            {
                FR_WindowLift.Window = objective.transform.Find("Firewall12/Firewall12/DoorFR12/DoorFR12/WindowLiftFR12/WindowLiftFR12/WindowFR12").gameObject;
                FR_WindowLift.WindowClosed = objective.transform.Find("Firewall12/Firewall12/DoorFR12/DoorFR12/WindowLiftFR12/WindowLiftFR12/WinUP").gameObject;
                FR_WindowLift.WindowOpen = objective.transform.Find("Firewall12/Firewall12/DoorFR12/DoorFR12/WindowLiftFR12/WindowLiftFR12/WinDown").gameObject;
            }

            // RR
            WindowLift RL_WindowLift = objective.transform.Find("RBpillar12/RBpillar12/DoorRR12/DoorRR12/WindowLiftRR12/WindowLiftRR12").GetComponent<WindowLift>();
            if (RL_WindowLift)
            {
                RL_WindowLift.Window = objective.transform.Find("RBpillar12/RBpillar12/DoorRR12/DoorRR12/WindowLiftRR12/WindowLiftRR12/WindowRR12").gameObject;
                RL_WindowLift.WindowClosed = objective.transform.Find("RBpillar12/RBpillar12/DoorRR12/DoorRR12/WindowLiftRR12/WindowLiftRR12/winUP").gameObject;
                RL_WindowLift.WindowOpen = objective.transform.Find("RBpillar12/RBpillar12/DoorRR12/DoorRR12/WindowLiftRR12/WindowLiftRR12/WinDown").gameObject;
            }

            // RL
            WindowLift RR_WindowLift = objective.transform.Find("LBpillar12/LBpillar12/DoorRL12/DoorRL12/WindowLiftRL12/WindowLiftRL12").GetComponent<WindowLift>();
            if (RR_WindowLift)
            {
                RR_WindowLift.Window = objective.transform.Find("LBpillar12/LBpillar12/DoorRL12/DoorRL12/WindowLiftRL12/WindowLiftRL12/WindowRL12").gameObject;
                RR_WindowLift.WindowClosed = objective.transform.Find("LBpillar12/LBpillar12/DoorRL12/DoorRL12/WindowLiftRL12/WindowLiftRL12/WinUp").gameObject;
                RR_WindowLift.WindowOpen = objective.transform.Find("LBpillar12/LBpillar12/DoorRL12/DoorRL12/WindowLiftRL12/WindowLiftRL12/WinDown").gameObject;
            }
        }
        ...
        public void SetupTemplate(GameObject objective, Car car)
        {
            ...
            // Fixing RVP.SUSP
            Transform WheelControllerFR = objective.transform.Find("FrontSusp/Crossmemmber12/WheelContParentFR");
            Transform WheelControllerFL = objective.transform.Find("FrontSusp/Crossmemmber12/WheelContParentFL");
            ...
            foreach (MyBoneSCR scr in objective.GetComponentsInChildren<MyBoneSCR>())
            {
                ...
                /*else if (scr.name == "CrossmemmberR12")
                {
                ...
                {
                    scr.targetTransform = objective.transform.Find("RearSusp/CrossmemmberR12/Pivotdriveshaft");
                }
            }
        ...
        internal static void RecreateNWH(GameObject objective, MainCarProperties mainCarProps, bool awd = false)
        {
            ...
            WheelFR = objective.transform.Find("FrontSusp/Crossmemmber12/WheelContParentFR/WheelControllerFR").GetComponent<WheelController>();
            WheelFL = objective.transform.Find("FrontSusp/Crossmemmber12/WheelContParentFL/WheelControllerFL").GetComponent<WheelController>();
