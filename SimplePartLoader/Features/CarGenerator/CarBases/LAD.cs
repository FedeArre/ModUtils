...
namespace SimplePartLoader.CarGen
{
    internal class LAD : ICarBase
    {
        ...
        {
            exceptions.ExceptionList["SafetyNet06"] = "none";
            exceptions.ExceptionList["RollCage06"] = "none";
            exceptions.ExceptionList["FlareFL06"] = "none";
            exceptions.ExceptionList["FlareFR06"] = "none";
            exceptions.ExceptionList["FlareRR06"] = "none";
