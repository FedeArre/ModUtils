...
#### Description
Creates a new [Part](api/part.md) given a bundle and a prefab. The prefab should be an empty GameObject that will be later used on [CopyPartToPrefab](api/spl/copyparttoprefab.md).
